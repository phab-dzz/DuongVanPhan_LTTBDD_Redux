...
function* fetchDataSaga() {
  try {
    const response = yield call(axios.get, 'https://6701579eb52042b542d782e5.mockapi.io/datadb');
...
function* createDataSaga(action) {
  try {
    const response = yield call(axios.post, 'https://6701579eb52042b542d782e5.mockapi.io/datadb', action.payload);
...
function* updateDataSaga(action) {
  try {
    const response = yield call(axios.put, `https://6701579eb52042b542d782e5.mockapi.io/datadb/${action.payload.id}`, action.payload.data);
...
function* deleteDataSaga(action) {
  try {
    yield call(axios.delete, `https://6701579eb52042b542d782e5.mockapi.io/datadb/
    ${action.payload}`);
